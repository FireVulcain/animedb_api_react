...
export default class Spring extends Component {
    render() {
        ...
        let description = `Find, track, and share what's airing during the Spring ${year} anime season. Find the top-rated and most popular shows, OVAs, and movies!`;
        return (
            <Head
                pageMeta={{
            ...
            >
                <div className="main-content">
                    <div>
                        ...
                        {currentSeason === season ? <Leftovers season="WINTER" year={year} /> : null}
